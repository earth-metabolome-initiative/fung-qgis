...
DEFAULT_SPECIES = Path("data/inaturalist/switzerland_species_observations_resolved.csv")
DEFAULT_HIGHER_TAXA = Path("data/inaturalist/switzerland_higher_taxa_resolved.csv")
DEFAULT_OUTPUT = Path("qgis/fung/species_list.csv")
